...
if (isset($_POST['BtnAdd']) && $_POST['titOri']!='' && $_POST['titFr']!='' && $_POST['Clas']!='' && $_POST['dur']!='' && $_POST['anneeSort']!='' && $_POST['res']!='' && $_POST['img']!='' && $_POST['nbEp']!=''){
    $Classification1 = $ClassificationDAO->findCla($_POST['Clas']);
    $Oeuvre = new \BO\Oeuvre(0,$_POST['titOri'],$_POST['titFr'],$_POST['anneeSort'],$_POST['res'],$_POST['nbEp'],$_POST['img'],$Classification1);
//------------------------------------------acteurs----------------------------------------
    if ($_POST['Acteur1']!=''){
    ...
    $testcreate = $OeuvreDAO->createOeuvre($Oeuvre);
    //var_dump($testcreate);
    header('Location:ListeOeuvre.php');
}else {
    include('../vue/ajouterOeuvre.php');
